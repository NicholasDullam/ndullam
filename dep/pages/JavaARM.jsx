...
import { LoadingIcon, Social, Tag } from "../../client/src/components";
import subset from "../../public/assets/documents/java-subset.txt";
import javaarm1 from "../../public/assets/images/java-arm-1.png";
      ...
      <div className="p-8 pt-3">
        ...
        >
          ...
          <div style={{ color: "white", marginLeft: "auto" }}>
            <Social
              name="GitHub"
              link="https://github.com/NicholasDullam/arm_java"
            />
          </div>
        </div>
              ...
              <p style={{ whiteSpace: "pre-wrap" }}>
                <div
                  dangerouslySetInnerHTML={{
                    __html: highlight(output.trimEnd(), languages.armasm),
                  }}
                ></div>
              </p>
            </div>
