...
import { Tag } from "../../client/src/components";
import Communicode1 from "../../public/assets/images/communicode-1.jpeg";
  ...
  return (
    <div>
      ...
      <div className="p-8 pt-3">
        ...
        continuity of the backend development process as we expanded to an LLC.
        <h3 className="text-xl font-bold mt-5 mb-2">
          {" "}
