...
import loandefault1 from "../../public/assets/images/loan-default-1.png";
      ...
      <div className="p-8 pt-3">
        ...
        >
          ...
          <div style={{ color: "white", marginLeft: "auto" }}>
            <Social
              name="GitHub"
              link="https://github.com/NicholasDullam/loan_default"
            />
          </div>
        </div>
        ...
        <h3 className="text-xl font-bold mt-5 mb-2">
          {" "}
          Role |<span className="text-base opacity-50"> Member </span>{" "}
        </h3>
        <p>
          {" "}
        ...
        <p>
          {" "}
          As one of my first involved applications of machine learning, I found
